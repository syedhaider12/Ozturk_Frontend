...
function Contact() {
  ...
  <body className="px-8 py-12 text-gray-100 bg:text-white">
      <div className="w-full text-center">
        <svg className="h-8 mx-auto text-gray-100"  viewBox="0 0 150 29" version="1.1"
      ...
      <div
        className="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto mt-24 text-white bg-[#031e4a] rounded-lg shadow-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32">
        ...
        <div className="">
          <div>
            ...
            <input className="w-full p-3 mt-2 text-gray-900 bg-white rounded-lg focus:outline-none focus:shadow-outline"
              type="text" placeholder=""/>
          </div>
          <div className="mt-8">
            <span className="text-sm font-bold text-white uppercase">Email</span>
            <input className="w-full p-3 mt-2 text-gray-900 bg-white rounded-lg focus:outline-none focus:shadow-outline"
              type="text"/>
          </div>
          <div className="mt-8">
            <span className="text-sm font-bold text-white uppercase">Message</span>
            <textarea
              className="w-full h-32 p-3 mt-2 text-gray-900 bg-white rounded-lg focus:outline-none focus:shadow-outline"></textarea>
          </div>
          <div className="mt-8">
            <button
